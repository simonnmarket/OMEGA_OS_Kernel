"""Pipeline DOS com dados sintéticos (sem Postgres) — HARDENED."""
...
def test_pnl_hypothetical_label():
    mkt = _demo_like_frame(100)
    r = run_dos_pipeline(market=mkt, source="frame")
    assert r.summary.get("pnl_type") == "HYPOTHETICAL"
    assert PNL_DISCLAIMER in r.summary.get("pnl_disclaimer", "")

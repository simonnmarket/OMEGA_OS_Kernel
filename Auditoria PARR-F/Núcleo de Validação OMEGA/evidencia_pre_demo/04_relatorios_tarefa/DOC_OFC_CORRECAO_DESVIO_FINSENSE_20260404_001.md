# FIN-SENSE DATA MODULE — Schema Definitions (v1.2 - ULTIMATE HUB)
# Baseado no Inventário Expandido v1.0 (03/04/2026) enviado pelo CEO.

from typing import Dict, List, Any

# Estrutura Institucional Completa para Fundo de Investimento (Hub Central)
# Foco: Bolsas Internacionais, Microestrutura, Risco, Compliance e Governança.
...
SCHEMAS: Dict[str, List[Dict[str, str]]] = {
    ...
    "TBL_VWAP_INTRADAY": [
        {"name": "symbol", "type": "STRING", "mandatory": "YES"},
        {"name": "interval", "type": "STRING", "mandatory": "YES"}, # 1s, 1m, 5m
    ...
    "TBL_ORDERS": [
        ...
        {"name": "status", "type": "STRING", "mandatory": "YES"}, # new, ack, partial, fill, cancel, reject
    ...
    "TBL_CORP_ACTIONS": [
        {"name": "symbol", "type": "STRING", "mandatory": "YES"},
        {"name": "type", "type": "STRING", "mandatory": "YES"}, # split, dividend, spin-off
    ...
    "TBL_FUNDAMENTALS": [
        {"name": "symbol", "type": "STRING", "mandatory": "YES"},
        {"name": "metric_name", "type": "STRING", "mandatory": "YES"}, # EPS, Revenue, etc.

...
try:
    with open('config/regimes/hunter.json', 'r') as f:
        config_data = json.load(f)
except Exception as e:
    # Ignore and create a stub
    config_data = {}
...
class OmegaIntegrationGate:
    def __init__(self):
        import logging
        self.log = logging.getLogger('INTEGRATION_GATE')
        self.log.info('integration_gate ativo: DistribuitedConcurrencyModel engatilhado.')
        self.concurrency = DistributedConcurrencyModel()
    def validate_pre_execution(self, asset):
        return True
